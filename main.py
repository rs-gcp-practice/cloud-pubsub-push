...
app.config['PUBSUB_VERIFICATION_TOKEN'] = settings.PUBSUB_VERIFICATION_TOKEN
app.config['PUBSUB_TOPIC'] = settings.PUBSUB_TOPIC
app.config['PROJECT'] = settings.PROJECT
